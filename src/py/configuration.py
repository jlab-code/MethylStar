...
def conf_menu():
    ...
    print ycolor("1.")+" RAW files location"
    print ycolor("2.")+" Location to export the results"
    print ycolor("3.")+" Genome folder location"
    print ycolor("4.")+" Trimmomatic parameters"
    print ycolor("5.")+" QC-Fastq Path"
    print ycolor("6.")+" Bismark parameters"
    print ycolor("7.")+" Parallel mode"
    print ycolor("8.")+" See configured parameters"
...
def confirm(config_section, config_value, mcode):
    ...
    if not str_conf == '':
        if int(mcode == 33):
            if str_conf != "true":
                str_conf = "Currently you have files in Single case."
                mcode = 3
            else:
                str_conf = "Currently you have files in Pair case."
                mcode = 3
        ...
        if answer:
            ...
            message(mcode, "We will keep the default value!")
    else:
...
def raw_dataset():
    ...
    print "If you have data-set in pairs mode, you have to give the pattern of extension.\n"
    try:
        ...
        if confirm("GENERAL", "pairs_mode", 33):
            ...
            if read_config("GENERAL", "pairs_mode") == "true":
                print "Currently you have files in "+ ycolor("Pairs case.\n")
            else:
                print "Currently you have files in "+ycolor("Single case.\n")

            # pring ask enable or disable it
            sys.stdout.write(ycolor("1") + " -You have files in Single case.\n")
            sys.stdout.write(ycolor("2") + " -You have files in Pairs case.\n")
            ...
            if int(file_mode) == 1:
                ...
                print "--" * 30
                print(mcolor("Please specify the your data-set pattern."))
                print(mcolor("For example: if you have files like this:"))
                print(gcolor("XXXXX_1.fq.gz,\nXXXXX_2.fq.gz"))
                print("Yor first pattern will be:"+mcolor("_1.fq.gz"))
...
def genome_name():
    ...
    if len(onlyfiles) == 0:
        message(1, "We could't find any Reference file under "+di_tosearch+" folder.")
        message(2, "Please, copy Ref. genome into "+di_tosearch+" and re-config again.")

    else:
        print("we found this file(s) under the genome reference folder.\n")
    ...
    try:
        ...
        if confirm("Trimmomatic", "name_adap",3):
            ...
            if len(list_adaptors) == 0:
                message(1, "We could't find any Jar file under "+adap_tosearch+" folder.")
                message(2, "Please check directory "+adap_tosearch+" and re-config again.")
...
def bismark_path():
    ...
    if confirm("Bismark", "nucleotide", 3):
        ...
        sys.stdout.write(ycolor("2")+" -Disable (False)\n")
